...
module Gamification
  class Application < Rails::Application
    ...
    config.organisation = 'FKGent'

    config.repository_filters = {
        # only: [ 'gamification', 'Haldis' ]
        only: %w(FKSportsysteem Falador GenerationY theironbank Compendium fkpompwater fkweb fkquiz fkbooks Zwemmarathon HILOK AlKharid Varrock Piscatoris)
