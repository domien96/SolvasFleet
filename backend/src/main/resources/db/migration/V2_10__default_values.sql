...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.2710,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
  WHERE vehicle_types.name like 'PersonalVehicle' AND insurance_types.name like 'CivilLiability';


INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.1675,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.2675,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.1425,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.1390,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.1285,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.1250,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.2210,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
...
INSERT INTO taxes (tax,vehicletype_id,insurancetype_id)
  (SELECT 0.2175,vehicletype_id,insurancetype_id FROM vehicle_types JOIN insurance_types
