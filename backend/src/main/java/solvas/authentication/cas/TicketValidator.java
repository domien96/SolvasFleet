 ...
 * @since 3.1
 */
public final class TicketValidator extends AbstractUrlBasedTicketValidator {
    ...
    private static String SAML_REQUEST_TEMPLATE;
    ...
    public TicketValidator(final String casServerUrlPrefix, ResourceLoader resourceLoader) {
