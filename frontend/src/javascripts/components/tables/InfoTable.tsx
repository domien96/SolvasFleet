...
export class InfoTable extends React.Component<InfoTableProps, {}> {

  public getRows() : any {
    var { head, data } = this.props;

    return data.map((item : any, i : number) => {
      const cells = head.map((headData : tableHead, j : number) => {
        return (
...
export function th(key : string, label : string) : tableHead {
