              ...
              <div className='card-content'>
                ...
                <div className='login-form-wrapper'>
                  <form method='POST' onSubmit={this.onSubmit} className='login-form' >
                    <FormField value={ this.state.email } placeholder='form.placeholders.email' name='email' type='email' callback={this.handleEmailChange} hasError={this.hasError('email')} />
