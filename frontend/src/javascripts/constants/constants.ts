...
export function INVOICES_URL(companyId: number, fleetId: number) { return `${BASE_API_URL}/companies/${companyId}/fleets/${fleetId}/invoices`; }
...
export function INVOICE_PDF_URL(companyId: number, fleetId: number, invoiceId: number) { return `${BASE_API_URL}/companies/${companyId}/fleets/${fleetId}/invoices/${invoiceId}${'.pdf'}`; }
