import { isExpired } from '../../javascripts/modules/Auth.ts';
...
test('isTokenExpired tested with real tokens', () => {
  const expiredToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOiIxMTE0Njk0NTY1In0.M78lggOEMzNTH0Ft5r3ZKlchhmRrev29n4piBj4ZonY';
  //Will expire in the year 2038
  const futureToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOiIyMTU2MDczNzY1In0.cJmoEQKYw4r2MBU1s6NAhS9QtGN7owDsGl8PseXODJ0';
