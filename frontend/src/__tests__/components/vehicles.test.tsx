...
jest.mock('../../javascripts/actions/vehicle_actions.ts', () => ({
  fetchVehicles: jest.fn().mockImplementation((b)=>b({"data":[{"id":"1","licensePlate":"AA","brand":"volvo","vin":"EE","model":"R","type":"T","mileage":1000,"year":1990,"leasingCompany":1,"fleet":2,"value":3000}]}))
}));
test('Vehicles renders correctly',()=>{
  var vehicles = mount(<Vehicles/>);
  expect(vehicles.find('Layout').prop('response')).toEqual({"data":[{"id":"1","licensePlate":"AA","brand":"volvo","vin":"EE","model":"R","type":"T","mileage":1000,"year":1990,"leasingCompany":1,"fleet":2,"value":3000}]});
})
