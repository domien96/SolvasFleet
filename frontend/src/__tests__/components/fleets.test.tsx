...
var fleetsData: FleetData[] = [ { id: 1, name: "Fleet1", company: 1, facturationPeriod: 3, paymentPeriod: 1 } ];

test('render Fleets correctly', () => {
  var fleets = mount(<Fleets fleets={ fleetsData } company={ 1 }/>);
...
test('render FleetForm correctly', () => {
  var form = mount(<FleetForm fleet={ fleetsData[0] } onSubmit={ jest.fn() } handleChange={ jest.fn() }/>);
