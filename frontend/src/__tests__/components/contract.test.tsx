...
jest.mock('../../javascripts/actions/contract_actions.ts', () => ({
  fetchContract: jest.fn().mockImplementation((a,b)=>b({"id":"10","insuranceCompany":"1","vehicle":"1","type":"billing","franchise":"100","premium":"200","startDate":"01-01-2010","endDate":"01-09-2010"},
}));
