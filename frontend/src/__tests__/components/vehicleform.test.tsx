...
test('Info of vehicleform renders correctly',()=>{
  ...
  expect(info.containsMatchingElement(<FormChoice value={vehicle.type} placeholder='vehicle.type'
  choices={
    ...
    {"key":"Truck","label":"vehicle.options.Truck"}]  }/>)).toBeTruthy();
...
test('Render AddVehicle correctly',()=>{
  ...
  form.instance().handleChange('id',{target:{value:vehicle.id}});
  form.instance().handleChange('licensePlate',{target:{value:vehicle.licensePlate}});
  form.instance().handleChange('vin',{target:{value:vehicle.vin}});
  form.instance().handleChange('brand',{target:{value:vehicle.brand}});
  form.instance().handleChange('type',{target:{value:vehicle.type}});
  form.instance().handleChange('mileage',{target:{value:vehicle.mileage}});
  form.instance().handleChange('year',{target:{value:vehicle.year}});
  form.instance().handleChange('leasingCompany',{target:{value:vehicle.leasingCompany}});
  form.instance().handleChange('value',{target:{value:vehicle.value}});
  form.instance().handleChange('fleet',{target:{value:vehicle.fleet}});
  form.instance().handleChange('model',{target:{value:vehicle.model}});
