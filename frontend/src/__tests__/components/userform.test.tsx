...
test('Render AddUser correctly',()=>{
  ...
  form.instance().handleChange('id',{target:{value:user.id}});
  form.instance().handleChange('firstName',{target:{value:user.firstName}});
  form.instance().handleChange('lastName',{target:{value:user.lastName}});
  form.instance().handleChange('email',{target:{value:user.email}});
  form.instance().handleChange('password',{target:{value:user.password}});
