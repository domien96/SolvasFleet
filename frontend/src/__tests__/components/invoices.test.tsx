...
test('Invoice renders correctly', () => {
  const invoice = mount(<Invoice params={ { fleetId: 1, invoiceId: 1 } }/>);
...
test('Invoices renders correctly', () => {
  const invoices = mount(<Invoices params={ { fleetId: 1 } }/>);
...
test('InvoicesView renders correctly', () => {
  const invoicesView = mount(<InvoicesView invoices={ [ inv ] }/>);
