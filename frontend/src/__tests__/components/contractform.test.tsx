...
test('Rendering addcontract',()=>{
  ...
  form.instance().handleChange("id",{target:{value:contract.id}},null);
  form.instance().handleChange("insuranceCompany",{target:{value:contract.insuranceCompany}},null);
  form.instance().handleChange("vehicle",{target:{value:contract.vehicle}},null);
  form.instance().handleChange("type",{target:{value:contract.type}},null);
  form.instance().handleChange("franchise",{target:{value:contract.franchise}},null);
  form.instance().handleChange("premium",{target:{value:contract.premium}},null);
  form.instance().handleChange("startDate",contract.startDate,"date");
  form.instance().handleChange("endDate",contract.endDate,"date");
