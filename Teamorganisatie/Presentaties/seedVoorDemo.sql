...
insert into users (user_id,first_name, last_name, email, password) VALUES (1,'Nils', 'Mak', 'nils.mak@gmail.com', 'pass');
INSERT INTO "users" (user_id,first_name,last_name,email,password,updated_at,created_at) VALUES (2,'Sierra','Cooper','metus.vitae.velit@facilisismagnatellus.net','WBL90DHP2RU','2017-02-28 12:15:29','2018-01-27 01:41:55');
INSERT INTO "users" (user_id,first_name,last_name,email,password,updated_at,created_at) VALUES (3,'Lamar','Yang','eleifend.Cras@tellusimperdiet.edu','GTZ20SSS5HV','2017-01-25 22:22:47','2017-04-30 09:44:22');
INSERT INTO "users" (user_id,first_name,last_name,email,password,updated_at,created_at) VALUES (4,'Hanna','Sims','ac.mattis.semper@semegetmassa.org','HPQ85RQA5VS','2016-11-20 23:35:34','2018-01-01 07:59:24');

--INSERT INTO "vehicle_types" (vehicletype_id,name) VALUES (1,'Persoonswagen'),(2,'Trekker'),(3,'Aanhangwagen'),(4,'Camionet'),(5,'Moto');


INSERT INTO "companies" (company_id,name,vat,phone,address_city,address_country,address_house_number,address_postalCode,address_street,updated_at,created_at,company_type) VALUES (1,'Volutpat Company','Q57E87DW34DR','08 90 21 34 65','Lanco','Saudi Arabia',159,'573460','Ap #373-5592 Duis St.','2016-01-12 23:46:04','2016-06-09 07:57:09',0);
...
INSERT INTO "vehicles" (vehicle_id,license_plate,chassis_number,model,kilometer_count,year,leasing_company_id,value,brand,vehicletype_id,updated_at,created_at) VALUES (4,'1-AXA-146','1FTZR45E99PA53535','A4',384999,2009,3,26004,'Skoda',3,'2015-10-30 00:23:20','2016-08-17 00:13:29');
INSERT INTO "vehicles" (vehicle_id,license_plate,chassis_number,model,kilometer_count,year,leasing_company_id,value,brand,vehicletype_id,updated_at,created_at) VALUES (5,'1-ING-148','1J4FJ28SXNL202014','911',384999,2009,3,26004,'Honda',3,'2015-10-30 00:23:20','2016-08-17 00:13:29');


INSERT INTO "fleets" (fleet_id,company_id,name,updated_at,created_at,facturation_period,payment_period) VALUES (1,1,' Heftrucks ','2015-10-11 05:48:39','2010-11-01 01:22:30',1,1);
INSERT INTO "fleets" (fleet_id,company_id,name,updated_at,created_at,facturation_period,payment_period) VALUES (2,1,' Vrachtwagens','2015-09-27 01:31:01','2010-06-17 08:10:44',1,1);
INSERT INTO "fleets" (fleet_id,company_id,name,updated_at,created_at,facturation_period,payment_period) VALUES (3,2,'Vracht ','2015-12-17 04:32:24','2010-07-11 20:26:16',1,1);
...
INSERT INTO contracts (contract_id,fleet_subscription_id, startDate,endDate,franchise,premium,company_id,insurance_type_id) VALUES (1,1,'2014-02-21','2015-11-16',100,100,1,1);
